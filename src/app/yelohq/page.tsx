...
const projects: ProjectCard[] = [
  {
    id: 'lightnet',
    title: 'Lightnet',
    description: "A future-proof 100% regulatory compliance interoperable payment solution provider for faster, cheaper and easier international transfer.",
    url: ' https://www.lightnet.io/',
    img_url: '/XRP/lightnet.png',
    position: { x: 250, y: 0 },
    orbit: 'inner'
  },
  {
    id: 'evolve',
    title: 'Evolve',
    description: 'Multi-asset, multi-chain tokenization initiative revolutionizing fractional ownership',
    url: 'https://www.evolverwa.io/',
    img_url: '/XRP/evolve.png',
  ...
  },
  {
    id: 'velo',
    title: 'Velo',
    description: 'VELO Bridges TradFi and Web3. Bringing Financial Inclusion to Emerging Markets',
    url: 'https://www.velo.org/',
    img_url: '/XRP/velo_dark.png',
    position: { x: -202.25, y: 147.0 },
    orbit: 'inner'
  },
  {
    id: 'usdv',
    title: 'USDV Stablecoin',
      ...
      <div className="relative w-full max-w-4xl h-[600px] flex items-center justify-center">
        ...
        >
          <motion.div
            ...
            style={{
              boxShadow: "0 0 148.855px 0 #E32970"
