...
const projects: ProjectCard[] = [
  ...
  },
  {
    id: 'consensys',
    title: 'Consensys',
    description: 'We build the tools, infrastructure, and research that power Ethereum',
    url: 'https://consensys.io/',
    img_url: '/XRP/consenys.png',
  ...
  },
  {
    id: 'ondo-finance',
    title: 'Ondo Finance',
    description: 'We build institutional-grade platforms and infrastructure to bring financial markets on-chain.',
      ...
      <div className="relative w-full max-w-4xl h-[600px] flex items-center justify-center">
        ...
        >
          <motion.div
            ...
            style={{
              boxShadow: "0 0 148.855px 0 #0c0c0c"
