...
const projects: ProjectCard[] = [
  ...
  },
  {
    id: 'palisade',
    title: 'Palisade',
    description: 'Purpose-built wallet infrastructure for stablecoins and payments',
    url: ' https://www.palisade.co/',
    img_url: '/XRP/palisade.png',
    position: { x: -202.25, y: -147.0 },
    orbit: 'outer'
  },
  {
    id: 'vivoPower',
    title: 'VivoPower',
    description: 'The First Digital Asset Treasury Company for $XRP',
    url: 'https://vivopower.com/',
    img_url: '/XRP/vivopower-blue.png',
    position: { x: 77.25, y: -238.5 },
    orbit: 'outer'
  }
]
